...
const initialiseTests = async () => {
  ...
  return {
    ...
    user1Id: 1,
    user1Category1Id: 1,
    user1Category1Project1Id: 1,
    user1Category1Project1Task1Id: 1,
    user1Category1Project1Task1Entry1Id: 1,
    user1Category1Project1Task2Entry1Id: 2,
    user1Category1Project1Task3Entry1Id: 3,
    user2Token,
    user2Id: 2,
    user2Category1Id: 2,
    user2Category1Project1Id: 2,
    user2Category1Project1Task1Id: 4,
    user2Category1Project1Task1Entry1Id: 4,
  }
}
