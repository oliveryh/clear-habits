...
BEGIN
	...
	INSERT INTO app_public.tasks (person_id, project_id, description, complete) VALUES (user2, user2_project, 'Task Complete', true) RETURNING id into user2_task_complete;
	INSERT INTO app_public.entries (person_id, task_id, description, complete) VALUES (user2, user2_task_complete, 'Entry Complete', true) RETURNING id into user2_entry_complete;
END $$;
